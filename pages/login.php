...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $request = new UserLoginRequest($username, $password);
...
<div class="w-screen h-screen flex items-center justify-center">
    <div class="w-1/4 h-1/2 mx-auto flex flex-col justify-center">

        <?php if (!empty($error)) { ?>
            <div class="w-100">
                <div class="text-center py-4 lg:px-4">
                    <div class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-lg flex lg:inline-flex"
                         role="alert">
        ...
        <form action="" method="POST">
            <div class="flex flex-col mb-2">
                <label for="username" class="text-[14px] mb-2">Nama Pengguna
                    <input name="username" type="text"
                           class="w-full h-12 bg-neutral-100 rounded-lg px-4 ring-1 ring-inset ring-gray-300 outline-2 outline-yellow"
            ...
            <button type="submit"
                    class="h-12 bg-yellow my-[24px] rounded-lg font-semibold text-indigo-50 w-full ring-1 ring-inset ring-yellow">
                Masuk
            </button>
