    ...
    <div class="w-screen h-screen flex items-center justify-center">
        <div class="w-1/4 h-1/2 mx-auto flex flex-col justify-center">
            ...
            <form action="" method="POST">
                ...
                <button type="submit" class="h-12 bg-yellow my-[24px] rounded-lg font-semibold text-indigo-50 w-full ring-1 ring-inset ring-yellow">
                    Masuk
                </button>

                <p class='text-center'>Belum punya akun? <span class='cursor-pointer' onclick="window.location.href='register.php'">Daftar akun</span>
            </form>
        </div>
    </div>
</body>
